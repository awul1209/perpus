...
if ($dari == '' && $sampai == '') {
    $result = mysqli_query($koneksi, 'SELECT id_pengembalian,nama_anggota,judul_buku,tgl_pinjam,tgl_kembali,tgl_pengembalian FROM pengembalian
 ...
 JOIN buku ON pengembalian.id_buku=buku.id_buku  ORDER BY id_pengembalian DESC');
    ...
    $result = mysqli_query(
        $koneksi,
        "SELECT id_pengembalian,nama_anggota,judul_buku,tgl_pinjam,tgl_kembali,tgl_pengembalian FROM pengembalian
 JOIN anggota ON pengembalian.id_anggota=anggota.id_anggota
 JOIN buku ON pengembalian.id_buku=buku.id_buku WHERE 
